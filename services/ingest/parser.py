...
# Bound strip_html cost on very large documents (only capped item text
# reaches the LLM anyway)
...
def build_filing(entry: dict, detail: dict, ticker_map: dict) -> Filing:
    """Assemble a Filing from an 8-K feed entry + filing detail + ticker map."""
